...
const char *get_planet_filename(celestial_t planet) {
  ...
  case SUN:
    return "./data/sun.csv";
  case MERCURY:
    return "./data/mercury.csv";
  case VENUS:
    return "./data/venus.csv";
  case EARTH:
    return "./data/earth.csv";
  case MARS:
    return "./data/mars.csv";
  case JUPITER:
    return "./data/jupiter.csv";
  case SATURN:
    return "./data/saturn.csv";
  case URANUS:
    return "./data/uranus.csv";
  case NEPTUNE:
    return "./data/neptune.csv";
  case PLUTO:
    return "./data/pluto.csv";
  default:
    return NULL;
  }
}
